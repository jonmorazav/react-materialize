  ...
  _createClass(Autocomplete, [{
    ...
    value: function render() {
      var _props2 = this.props,
          ...
          props = _objectWithoutProperties(_props2, ['id', 'className', 'title', 'data', 'icon', 'iconClassName', 's', 'm', 'l', 'offset', 'minLength', 'placeholder', 'limit', 'value', 'onChange', 'onAutocomplete', 'onFocus', 'onBlur', 'inputClassName']);
